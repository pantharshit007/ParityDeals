...
import { productCustomizationSchema } from "@/data/types/zod-type";
...
export function ProductCustomizationForm({
  ...
  async function onSubmit(values: z.infer<typeof productCustomizationSchema>) {
    const data = await updateProductCustomizationAction(customization.productId, values);
    if (data?.error) {
      toast.error(data.message);
      console.log("Error in updating product customization", data.message);
    }
